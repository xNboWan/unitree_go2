...
All the environments are registered in the `unitree_go2` extension. They start
...
import unitree_go2.tasks  # noqa: F401


def main():
    """Print all environments registered in `unitree_go2` extension."""
